    ...
    <div className="About-page-wrapper">
      ...
      <div className="About-page-details">
        <h3 className="About-details-top">
          ...
          anything I could get my hands on (and fixing the family computer every
          time my parents opened an email they shouldn't have). I'm always eager
          to learn new technologies and stay ahead of the curve.
        </h3>
        <h3>
